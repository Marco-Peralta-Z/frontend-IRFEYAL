    ...
    <section class="full-box cover dashboard-sideBar">
        ...
        <div class="full-box dashboard-sideBar-ct">
            ...
            <div class="full-box text-uppercase text-center text-titles dashboard-sideBar-title">
                IRFEYAL <i class="zmdi zmdi-close btn-menu-dashboard visible-xs"></i>
            </div>
            <!-- SideBar User info -->
            ...
            <ul class="list-unstyled full-box dashboard-sideBar-Menu">
                ...
                <li>
                    ...
                    <ul class="list-unstyled full-box">
                        ...
                        <li>
                            <a href="subject.html"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Materia</a>
                        </li>
                        <li>
                            <a href="section.html"><i class="zmdi zmdi-graduation-cap zmdi-hc-fw"></i> Paralelo</a>
                        </li>
                        <li>
                            <a href="salon.html"><i class="zmdi zmdi-font zmdi-hc-fw"></i> Curso</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href="#!" class="btn-sideBar-SubMenu">
                        <i class="zmdi zmdi-shield-security zmdi-hc-fw"></i> Inventarios <i class="zmdi zmdi-caret-down pull-right"></i>
                    </a>
                    <ul class="list-unstyled full-box">
                        <li>
                            <a href="../mgim/index.php"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> Inventarios</a>
                        </li>
                    </ul>
                </li>
            </ul>
